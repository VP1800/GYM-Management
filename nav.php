...
<a class="nav-items" href="staff.php"><i class="fa fa-list-ol"></i> Staff</a>
<!-- <a class="nav-items" href="rstaff.php"><i class="fa fa-list-ol"></i> Recent Staff</a> -->
...
<!-- <a class="nav-items" href="missing.php" class="change-password"><i class="fa fa-bank" ></i> status</a>
<a class="nav-items" href="inventory.php" class="change-password"><i class="fa fa-bank" ></i> inventory</a> -->
