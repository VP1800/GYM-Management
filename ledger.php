...
if(isset($_REQUEST["e_id"]))
{
    ...
    $query = "SELECT e_id,date,category_name,party_name,amount,payment_method,description FROM `expense_ledger` where category_name='Machinery/Mentainence'";
...
$query = "SELECT p_id, bill_no, party_name,item, amount, date, description, status FROM `purchases` where `status`='active'";
$result = mysqli_query($connection, $query);
?>
<div id="Paris" class="city" style="display:none">
    ...
    <form id="purchaseForm" action="#" enctype="multipart/form-data" method="post"  onblur="errorhide()" onsubmit="return formSubmission()" style="text-align: -webkit-center;">
            ...
            <div class="container1">
                <div class="input-container">
                        <label for="bill_no">Quantity</label>
                        <input type="number" id="bill_no" onblur="return validateBill()" name="bill_no" value="<?php echo $bill_no; ?>">
                    </div>
